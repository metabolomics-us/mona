...
output:
  pdf_document:
    ...
    toc: yes
  html_document:
    css: http://mona.fiehnlab.ucdavis.edu/styles/774b40ea.main.css
    number_sections: yes
    theme: journal
    toc: yes
  word_document:
...
listOfExternalDatabases <- c('MassBank','respect')
...
from
   ...
   select
      ...
      where
         ...
         and b.id = d.spectrum_id 
         and d.compound_id = c.id 
         and lower(g.name) = 'precursor type'
...
from
   ...
   select
      ...
      where
         ...
         and b.id = d.spectrum_id 
         and d.compound_id = c.id 
         and lower(g.name) = 'derivative type'
...
from
   ...
   select
      ...
      where
         ...
         and b.id = d.spectrum_id 
         and d.compound_id = c.id 
         and lower(g.name) = 'instrument type'
