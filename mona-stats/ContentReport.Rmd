...
qplot(data=experimentalVsPredictedSpectraReport,x=experimentalVsPredictedSpectraReport$database,y=experimentalVsPredictedSpectraReport$count,geom="bar",stat="identity",xlab="type of spectra",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))+ coord_flip()
```
...
qplot(data=spectraCountForDatabases,x=spectraCountForDatabases$database,y=spectraCountForDatabases$count,geom="bar",stat="identity",xlab="origin",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
...
qplot(data=duplicatedSpectraReport,x=c('total','uniquespectra','duplicated'),y=c(duplicatedSpectraReport$total,duplicatedSpectraReport$uniquespectra,duplicatedSpectraReport$duplicated),geom="bar",stat="identity",xlab="spectra",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  coord_flip()
...
ggplot(data=spectraIonDistribution, aes(spectraIonDistribution$ioncount)) + geom_histogram(breaks=seq(0,100), aes(fill=..count..)) + ggtitle("distribution of spectra ion counts") +
...
```{r,echo=FALSE,fig.width=7, fig.height=4, fig.align='center'}
qplot(data=aquistionMethodReport,x=aquistionMethodReport$method,y=aquistionMethodReport$count,geom="bar",stat="identity",xlab="aquisition method",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))+ coord_flip()
```
...
```{r,echo=FALSE,fig.width=7, fig.height=4, fig.align='center'}
qplot(data=msLevelTypeReport,x=msLevelTypeReport$value,y=msLevelTypeReport$count,geom="bar",stat="identity",xlab="MS Type",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1)) + coord_flip()
```
...
```{r,echo=FALSE,fig.width=7, fig.height=4, fig.align='center'}
qplot(data=ionModeReport,x=ionModeReport$value,y=ionModeReport$count,geom="bar",stat="identity",xlab="Ion Mode",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1)) + coord_flip()
```
...
qplot(data=precursorTypeReport,x=precursorTypeReport$value,y=precursorTypeReport$count,geom="bar",stat="identity",xlab="Precursor Type",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1)) + coord_flip()
```
...
```{r,echo=FALSE,fig.width=7, fig.height=8, fig.align='center'}
qplot(data=derivativeTypeReport,x=derivativeTypeReport$value,y=derivativeTypeReport$count,geom="bar",stat="identity",xlab="Derivative Type",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1)) + coord_flip()
```
...
```{r,echo=FALSE,fig.width=7, fig.height=8, fig.align='center'}
qplot(data=tagsDistribtution,x=tagsDistribtution$value,y=tagsDistribtution$count,geom="bar",stat="identity",xlab="Tag/Label",ylab="count of spectra")+ theme(axis.text.x = element_text(angle = 90, hjust = 1)) + coord_flip()
```
...
ggplot(data=importStatistics,aes(x= value)) + geom_histogram(binwidth=100, fill=NA,color="black") + xlim(0,10000) + xlab("duration in ms") + ylab("count of imports")
...
ggplot(data=validationStatistics,aes(x= value)) + geom_histogram(binwidth=150, fill=NA,color="black") + xlim(0,15000) + xlab("duration in ms") + ylab("count of validations")
...
ggplot(data=scoringStatistics,aes(x= value)) + geom_histogram(binwidth=50, fill=NA,color="black") + xlim(0,5000) + xlab("duration in ms") + ylab("count of scorings")
...
The current system contains hundred of diffrent meta data types and to optimize the rule based autocuration system, we are utilizing this report to adjust the data types accordingly.
