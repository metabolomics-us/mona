...
public class GatewaySwaggerResourceProvider implements SwaggerResourcesProvider {
    ...
    public List<SwaggerResource> get() {
        ...
        routes.forEach(route -> {
            log.info("path: " + route.getPath() + " and service " + route.getLocation());

            List<ServiceInstance> services = discoveryClient.getInstances(route.getLocation());
            ...
            if (services.size() > 0) {
                ...
                String newRoute = "/" + route.getLocation() + "/v2/api-docs";

                cache.put(location, swaggerResource(route.getLocation(), newRoute, "2.0"));
