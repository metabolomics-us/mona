...
export default servuce AuthenticationService {
  constructor(Submitter, $log, $q, $http, $rootScope, CookieService) {

  }
}

AuthenticationService.$inject = ['Submitter', '$log', '$q', '$http', '$rootScope', 'CookieService'];
