...
object CommonMetaData {
  val MASS_ACCURACY: String = "mass accuracy"

  val MASS_ERROR: String = "mass error"

  val EXACT_MASS: String = "exact mass"

  val TOTAL_EXACT_MASS: String = "total exact mass"
  ...
  val PRECURSOR_TYPE: String = "precursor type"
  ...
  val INSTRUMENT_TYPE: String = "instrument type"
