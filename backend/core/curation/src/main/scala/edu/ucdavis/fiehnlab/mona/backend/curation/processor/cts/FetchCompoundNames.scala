...
/**
  ...
  */
@Step(description = "this fetches all names from the CTS system and updates MoNA with them", previousClass = classOf[FetchCompoundIds], workflow = "spectra-curation")
