...
CREATE INDEX IF NOT EXISTS statistics_metadata_name_index on statistics_metadata(name);
CREATE INDEX IF NOT EXISTS metadata_name_index ON metadata using hash(name);
CREATE INDEX IF NOT EXISTS metadata_value_index ON metadata using hash(value);