package edu.ucdavis.fiehnlab.mona.backend.core.persistence.rest.server.controller.webhooks

import edu.ucdavis.fiehnlab.mona.backend.core.persistence.rest.server.controller.GenericRESTController
import edu.ucdavis.fiehnlab.mona.backend.core.persistence.rest.server.repository.WebHook
