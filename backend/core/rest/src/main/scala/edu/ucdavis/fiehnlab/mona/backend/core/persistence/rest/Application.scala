...
import edu.ucdavis.fiehnlab.mona.backend.core.persistence.mongo.config.{MongoConfig, RepositoryConfiguration}
...
@Import(Array(classOf[RepositoryConfiguration], classOf[MongoConfig], classOf[RESTConfig]))
class Application
