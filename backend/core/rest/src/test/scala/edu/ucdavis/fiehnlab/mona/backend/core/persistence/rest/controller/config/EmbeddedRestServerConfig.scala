...
import edu.ucdavis.fiehnlab.mona.backend.core.persistence.rest.config.RestServerConfig
...
/**
  ...
  */
@Configuration
@Import(Array(classOf[EmbeddedMongoDBConfiguration],classOf[EmbeddedElasticSearchConfiguration], classOf[RestServerConfig]))
