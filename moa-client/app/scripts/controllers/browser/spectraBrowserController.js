...
(function() {
    ...
    moaControllers.SpectraBrowserController = ['$scope', 'Spectrum', 'Compound', '$uibModal', '$routeParams', 'SpectraQueryBuilderService',
        'MetadataService', 'TaggingService', '$log', '$location', 'SpectrumCache', '$rootScope', '$timeout',
        function($scope, Spectrum, Compound, $uibModal, $routeParams, SpectraQueryBuilderService, MetadataService, TaggingService, $log, $location, SpectrumCache, $rootScope, $timeout) {
