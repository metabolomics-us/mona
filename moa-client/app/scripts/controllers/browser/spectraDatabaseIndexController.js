...
(function() {
    ...
    moaControllers.SpectraDatabaseIndexController = ['$scope', '$http', '$location', 'SpectraQueryBuilderService', 'MetadataService', 'REST_BACKEND_SERVER',
        function($scope, $http, $location, SpectraQueryBuilderService, MetadataService, REST_BACKEND_SERVER) {
            /**
