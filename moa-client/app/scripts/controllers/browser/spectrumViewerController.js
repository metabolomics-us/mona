(function() {
    ...
    moaControllers.ViewSpectrumController = ['$scope', '$location', '$log', 'delayedSpectrum', 'CookieService', 'Spectrum',
      function($scope, $location, $log, delayedSpectrum, CookieService, Spectrum) {
        /**
