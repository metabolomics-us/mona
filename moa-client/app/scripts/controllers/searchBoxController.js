...
(function() {
    ...
    moaControllers.SearchBoxController = ['$scope', '$uibModal', '$location', '$route', 'SpectraQueryBuilderService',
        function($scope, $uibModal, $location, $route, SpectraQueryBuilderService) {
