...
(function() {
    ...
    moaControllers.SpectraUploadController = ['$scope', '$rootScope', '$uibModal', 'AuthenticationService', 'UploadLibraryService',
        function($scope, $rootScope, $uibModal, AuthenticationService, UploadLibraryService) {
            /**
