...
-- recreate all views and functions, since they changed --
...
delete from qrtz_simple_triggers where trigger_name in ( select trigger_name from qrtz_triggers where job_name ='moa.server.SpectraValidationJob');
delete from qrtz_triggers where job_name ='moa.server.SpectraValidationJob';
delete from qrtz_simple_triggers where trigger_name in ( select trigger_name from qrtz_triggers where job_name ='moa.server.CompoundCurationJob');
delete from qrtz_triggers where job_name ='moa.server.CompoundCurationJob';
delete from qrtz_simple_triggers where trigger_name in ( select trigger_name from qrtz_triggers where job_name ='moa.server.SpectraAssociationJob');
delete from qrtz_triggers where job_name ='moa.server.SpectraAssociationJob';

delete from qrtz_simple_triggers where trigger_name in ( select trigger_name from qrtz_triggers where job_name ='moa.server.SpectraUploadJob');
delete from qrtz_triggers where job_name ='moa.server.SpectraUploadJob';


-- replace delete tag, with delete flag and remove not longer required flag--

update spectrum set deleted = true where id in (
    select owner_id from tag a, tag_link b where b.tag_id = a.id and text = 'deleted'
);

delete from tag_link where tag_id in (select id from tag where text = 'deleted');

delete from tag where text = 'deleted';


--delete scores and splashes--
update spectrum set score_id = null;
delete from impact;
delete from score;
